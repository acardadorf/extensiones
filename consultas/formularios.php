...
function formulario1() {
    echo '<p>&nbsp;</p>';
    echo '<p>&nbsp;</p>';
    echo '<p><h3>Introduzca la extensión:</h3></p>';
    echo'<form action="muestrabusextension.php" method="post" name="forextension">';
...
function formulario2() {
    ...
    echo'<form action="muestrabusapellido.php" method="post" name="forapellido">';
...
function formulario3() {
    ...
    echo'<form action="muestrabusnombre.php" method="post" name="fornombre">';
...
function formulario4() {
    echo '<p>&nbsp;</p>';
    echo '<p>&nbsp;</p>';
    echo '<p><h3>Seleccione el centro:</h3></p>';
    echo'<form action="muestrabuscentro.php" method="post" name="forcentro">
